...
public class GameDataManager
{
    ...
    {
        charactersShopData.purchasedItemsIndexes.Add(characterIndex);
        SaveCharactersShopData();
    }
    public static List<int>GetAllPurchasedCharacter()
    {
       return charactersShopData.purchasedItemsIndexes;
        
    }
    public static int GetPurchasedCharacter(int index)
    {
        return charactersShopData.purchasedItemsIndexes[index];

    }
    static void LoadCharactersShopData()
    {
        charactersShopData= BinarySerializer.Load<CharactersShopData>("charactersShop-data.txt");
    ...
    {
        BinarySerializer.Save(charactersShopData, "charactersShop-data.txt");
